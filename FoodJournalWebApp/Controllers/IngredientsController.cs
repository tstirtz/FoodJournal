...
namespace FoodJournalWebApp.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public IngredientsController(FoodJournalWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Ingredient != null ? 
                          ...
                          Problem("Entity set 'FoodJournalWebAppContext.Ingredient'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FoodJournalWebAppContext.Ingredient'  is null.");
            }
            var ingredient = await _context.Ingredient.FindAsync(id);
            if (ingredient != null)
            {

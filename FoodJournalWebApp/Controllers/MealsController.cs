...
namespace FoodJournalWebApp.Controllers
{
    public class MealsController : Controller
    {
        ...
        public MealsController(FoodJournalWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Meal != null ? 
                          ...
                          Problem("Entity set 'FoodJournalWebAppContext.Meal'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Time")] Meal meal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Time")] Meal meal)
        {
            if (id != meal.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FoodJournalWebAppContext.Meal'  is null.");
            }
            var meal = await _context.Meal.FindAsync(id);
            if (meal != null)
            {
